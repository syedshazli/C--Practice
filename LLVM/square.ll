...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_square.cpp, i8* null }]
...
define dso_local noundef i32 @_Z6squarei(i32 noundef %0) #4 {
...
define dso_local noundef i32 @main() #5 {
  %1 = call noundef i32 @_Z6squarei(i32 noundef 10)
  %2 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_square.cpp() #0 section ".text.startup" {
